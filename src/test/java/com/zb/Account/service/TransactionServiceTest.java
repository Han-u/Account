...
import static com.zb.Account.type.TransactionType.CANCEL;
import static com.zb.Account.type.TransactionType.USE;
...
class TransactionServiceTest {
    ...
    void cancelTransaction_TransactionAccountUnMatch() {
        ...
        //when
        AccountException exception = assertThrows(AccountException.class,
                () -> transactionService.cancelBalance("transactionId", "10000000000", CANCEL_AMOUNT));
